...
$$._HashTable = {"": "Object;_table>,_modificationCount>",
  ...
  _deleteEntry$1: function(offset) {
    var key = $.CONSTANT3.$eq($.CONSTANT3, null) ? $.CONSTANT2 : $.CONSTANT3;
...
$$._LinkedHashTable = {"": "_HashTable;_table,_capacity,_entryCount,_deletedCount,_modificationCount,_container",
  ...
  _deleteEntry$1: function(offset) {
    ...
    key = $.CONSTANT3.$eq($.CONSTANT3, null) ? $.CONSTANT2 : $.CONSTANT3;
    $.$$indexSet$a(this._table, offset, key);
    this._deletedCount = $.$$add$n(this._deletedCount, 1);
    this._recordModification$0();
  }
...
$$.Snow = {"": "Object;numberOfFlake<,ctx,width>,heigth>,flakes,_random",
  _createFlake$0: function() {
    var t1, speedX, t2, x, y;
    t1 = this._random.nextInt$1(5);
    speedX = this._random.nextInt$1(3);
    t2 = this._random.nextInt$1(5);
    x = this._random.nextInt$1(this.width);
    y = this._random.nextInt$1(this.heigth);
    $.CONSTANT0.add$1(this.flakes, $.Flake$(x, y, t1 + 2, speedX, t2 + 2));
  },
  start$0: function() {
    return window.requestAnimationFrame$1(this.get$_animate());
  },
  _animate$1: function(time) {
    this.draw$0();
    window.requestAnimationFrame$1(this.get$_animate());
  },
  get$_animate: function() {
    return new $.BoundClosure$1(this, "_animate$1");
  },
  draw$0: function() {
    var t1, t2, t3, t4, i;
    t1 = this.ctx;
    t1.clearRect$4(0, 0, this.width, this.heigth);
    for (t2 = this.flakes, t3 = $.CONSTANT0.get$iterator(t2); t3.moveNext$0();) {
      t4 = t3.get$current();
      t4.draw$1(t1);
      t4.updatePosition$0();
    }
    $.CONSTANT0.removeMatching$1(t2, new $.Snow_draw_anon(this));
    for (i = 0; $.CONSTANT5.$lt(i, $.$$sub$n(this.numberOfFlake, t2.length)); ++i)
      this._createFlake$0();
  },
  Snow$4: function(ctx, width, heigth, numberOfFlake) {
    var i;
    this._random = $.Random_Random(null);
    for (i = 0; $.CONSTANT5.$lt(i, this.numberOfFlake); ++i)
      this._createFlake$0();
  }
};

$$.Flake = {"": "Object;size,speedX,speedY,x,y>",
  ...
  draw$1: function(ctx) {
    ctx.beginPath$0();
    ctx.arc$6(this.x, this.y, this.size, 0, 6.283185307179586, false);
...
$$.Navigator_getUserMedia_anon = {"": "Closure;completer_0",
  call$1: function(stream) {
    this.completer_0.complete$1(stream);
  }
};

$$.Navigator_getUserMedia_anon0 = {"": "Closure;completer_1",
...
$$.Snow_draw_anon = {"": "Closure;this_0",
  call$1: function(flake) {
    var t1, t2;
    t1 = flake.get$y();
    t2 = this.this_0;
    return $.$$gt$n(t1, t2.get$heigth()) === true || $.$$gt$n(flake.get$y(), t2.get$heigth()) === true;
  }
};
...
$$.main_anon = {"": "Closure;canvas_0,video_1,photoBuffer_2,photoContent_3",
  call$1: function(e) {
    var t1, previousImage, t2, photoContext, t3, data, photo;
    t1 = this.photoContent_3;
    previousImage = t1.query$1("img");
    if (previousImage != null)
      $.remove$0$a(previousImage);
    t2 = this.photoBuffer_2;
    photoContext = t2.getContext$1("2d");
    t3 = this.video_1;
    photoContext.drawImage$5(t3, 0, 0, t3.get$width(), t3.get$height());
    t3 = this.canvas_0;
    photoContext.drawImage$5(t3, 0, 0, t3.get$width(), t3.get$height());
    data = t2.toDataUrl$1("image/png");
    photo = $._ElementFactoryProvider_createElement_tag("img");
    t1.append$1(photo);
    t1 = $.$$tdiv$n(t3.get$width(), 2);
    photo.set$height($.$$tdiv$n(t3.get$height(), 2));
    photo.set$width(t1);
    photo.set$src(data);
  }
};

$$.main_anon0 = {"": "Closure;flakesRange_4,snow_5",
  call$1: function(e) {
    var t1 = $.int_parse(this.flakesRange_4.get$value(), null, null);
    this.snow_5.set$numberOfFlake(t1);
    return t1;
  }
};

$$.main_anon1 = {"": "Closure;video_6,content_7,acceptVideo_8,snow_9",
  call$1: function(stream) {
    var t1, t2;
    t1 = $.Url_createObjectUrl(stream);
    t2 = this.video_6;
    t2.set$autoplay(true);
    t2.set$src(t1);
    t2.get$onError().listen$1(new $.main__anon());
    t2.get$onLoadStart();
    t2.get$onLoadedMetadata().listen$1(new $.main__anon0(this.content_7, this.acceptVideo_8, this.snow_9));
  }
};
...
$$.main__anon0 = {"": "Closure;content_10,acceptVideo_11,snow_12",
  call$1: function(e) {
    $.add$1$a(this.acceptVideo_11.get$classes(), "invisible");
    $.remove$1$a(this.content_10.get$classes(), "invisible");
    this.snow_12.start$0();
  }
};
...
$.main = function() {
  var canvas, flakesRange, takePhoto, video, photoBuffer, photoContent, $content, acceptVideo, snow;
  canvas = document.query$1("#canvasSnow");
  flakesRange = document.query$1("#flakesRange");
  takePhoto = document.query$1("#takePhoto");
  video = document.query$1("#webcam");
  photoBuffer = document.query$1("#photoBuffer");
  photoContent = document.query$1("#photoContent");
  $content = document.query$1("#content");
  acceptVideo = document.query$1("#acceptVideo");
  takePhoto.get$onClick().listen$1(new $.main_anon(canvas, video, photoBuffer, photoContent));
  snow = $.Snow$(canvas.getContext$1("2d"), canvas.get$width(), canvas.get$height(), $.int_parse(flakesRange.get$value(), null, null));
  flakesRange.get$onChange().listen$1(new $.main_anon0(flakesRange, snow));
  window.navigator.getUserMedia$1$video(true).then$1(new $.main_anon1(video, $content, acceptVideo, snow));
};

$.Snow$ = function(ctx, width, heigth, numberOfFlake) {
  var t1 = new $.Snow(numberOfFlake, ctx, width, heigth, [], null);
  t1.Snow$4(ctx, width, heigth, numberOfFlake);
  return t1;
};

$.Flake$ = function(x, y, size, speedX, speedY) {
  return new $.Flake(size, speedX, speedY, x, y);
};
...
$.LocalMediaStream = {builtin$cls: "LocalMediaStream"};
...
$.CONSTANT12 = new $.EventStreamProvider("loadstart");
...
$.CONSTANT8 = new $.EventStreamProvider("change");
$.CONSTANT13 = new $.EventStreamProvider("error");
$.CONSTANT11 = new $.EventStreamProvider("loadedmetadata");
...
$.$defineNativeClass("DocumentFragment", {
  ...
  append$1: function(element) {
    $.add$1$a(this.get$children(), element);
  }
});
...
$.$defineNativeClass("Element", {"": "$$dom_children:children~,id>,$$dom_attributes:attributes~,$$dom_className:className},$$dom_lastElementChild:lastElementChild~",
...
$.$defineNativeClass("HTMLImageElement", {"": "height=,src<,width=,y>",
...
$.$defineNativeClass("HTMLMediaElement", {"": "autoplay<,error>,src<",
  get$onLoadedMetadata: function() {
    return $.CONSTANT11.forTarget$1(this);
  },
  get$onLoadStart: function() {
...
$.$defineNativeClass("Navigator", {
  getUserMedia$2$audio$video: function(audio, video) {
    var completer, options;
    completer = $._CompleterImpl$();
    options = $.makeLiteralMap(["audio", audio, "video", video]);
    this._ensureGetUserMedia$0();
    this._getUserMedia$3($.convertDartToNative_Dictionary(options), new $.Navigator_getUserMedia_anon(completer), new $.Navigator_getUserMedia_anon0(completer));
    return completer.future;
  },
  getUserMedia$1$video: function(video) {
    return this.getUserMedia$2$audio$video(false, video);
  },
  _ensureGetUserMedia$0: function() {
    if (!(this.getUserMedia))
      this.getUserMedia = (this.getUserMedia || this.webkitGetUserMedia || this.mozGetUserMedia ||this.msGetUserMedia);
  },
  _getUserMedia$3: function(options, success, error) {
    return this.getUserMedia(options,$.convertDartClosureToJS(success, 1),$.convertDartClosureToJS(error, 1));
  }
});

$.$defineNativeClass("Node", {"": "$$dom_childNodes:childNodes~,$$dom_localName:localName~,$$dom_namespaceUri:namespaceURI~",
  get$nodes: function() {
...
$.$defineNativeClass("SVGFEBlendElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEColorMatrixElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEComponentTransferElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFECompositeElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEConvolveMatrixElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEDiffuseLightingElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEDisplacementMapElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEFloodElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEGaussianBlurElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEImageElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEMergeElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEMorphologyElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEOffsetElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFEPointLightElement", {"": "y>"});

$.$defineNativeClass("SVGFESpecularLightingElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFESpotLightElement", {"": "y>"});

$.$defineNativeClass("SVGFETileElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFETurbulenceElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGFilterElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGForeignObjectElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGImageElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGMaskElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGPatternElement", {"": "height>,width>,y>"});

$.$defineNativeClass("SVGRectElement", {"": "height>,width>,y>"});
...
//@ sourceMappingURL=itsnowing.dart.js.map
