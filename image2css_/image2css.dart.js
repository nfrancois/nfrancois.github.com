...
$$.ListQueue = {"": "Collection;_table>,_head,_tail,_modificationCount>",
  ...
  addAll$1: function(_, elements) {
    ...
    if (typeof elements === "object" && elements !== null && (elements.constructor === Array || elements.$isList())) {
      ...
      if (t1 >= t3) {
        this._preGrow$1(t1);
        $.CONSTANT3.setRange$4(this._table, $length, addCount, elements, 0);
        ...
        if (addCount < endSpace) {
          $.CONSTANT3.setRange$4(t2, t1, addCount, elements, 0);
          this._tail = $.$$add$n(this._tail, addCount);
        } else {
          preSpace = addCount - endSpace;
          $.CONSTANT3.setRange$4(t2, t1, endSpace, elements, 0);
          $.CONSTANT3.setRange$4(this._table, 0, preSpace, elements, endSpace);
          this._tail = preSpace;
        }
      }
  ...
  _grow$0: function() {
    ...
    t3 = this._head;
    split = t2 - t3;
    $.CONSTANT3.setRange$4(newTable, 0, split, t1, t3);
    $.CONSTANT3.setRange$4(newTable, split, this._head, this._table, 0);
    this._head = 0;
  ...
  _writeToList$1: function(target) {
    ...
    if (t1) {
      ...
      $.CONSTANT3.setRange$4(target, 0, $length, this._table, this._head);
      return $length;
    } else {
      t1 = this._table;
      firstPartSize = t1.length - t2;
      $.CONSTANT3.setRange$4(target, 0, firstPartSize, t1, t2);
      $.CONSTANT3.setRange$4(target, firstPartSize, this._tail, this._table, 0);
...
$$.ListIterable = {"": "Iterable;",
  ...
  forEach$1$bailout1: function(state0, action, $length) {
    var t1, i;
    for (t1 = $.getInterceptor($length), i = 0; $.CONSTANT8.$lt(i, $length); ++i) {
      action.call$1(this.elementAt$1(this, i));
  ...
  toList$1$growable: function(_, growable) {
    ...
    if (growable === true) {
      t1 = this.get$length(this);
      result = $.List_List($);
      $.CONSTANT3.set$length(result, t1);
    } else
      result = $.List_List(this.get$length(this));
    for (i = 0; $.CONSTANT8.$lt(i, this.get$length(this)); ++i) {
...
$$.Converter = {"": "Object;reader>,imageInput,pixelSizeInput>,imageCss,_pixelSize<",
  ...
  _readFile$1: function(buffer) {
    ...
    array = $.Uint8Array_Uint8Array$fromBuffer(buffer, null, null);
    ...
    try {
      ...
      t1 = $.unwrapException(exception);
      if (typeof t1 === "object" && t1 !== null && !!t1.$isUnsupportedImageFormatException)
  ...
  _readSignature$1: function(array) {
    var imageHeader, signature, i, signature0;
    imageHeader = $.getRange$2$a(array, 0, 2);
    if (typeof imageHeader !== "string" && (typeof imageHeader !== "object" || imageHeader === null || imageHeader.constructor !== Array && !imageHeader.$isJavaScriptIndexingBehavior()))
      return this._readSignature$1$bailout(1, imageHeader);
    for (signature = 0, i = 0; i < imageHeader.length; ++i, signature = signature0)
      signature0 = (signature << 8 >>> 0) + $.$$and$n(imageHeader[i], 255);
    return signature;
  },
  _readSignature$1$bailout: function(state0, imageHeader) {
    var t1, signature, i, signature0;
    for (t1 = $.getInterceptor$as(imageHeader), signature = 0, i = 0; $.CONSTANT8.$lt(i, t1.get$length(imageHeader)); ++i, signature = signature0)
...
$$.BMPReader = {"": "ImageReader;_pixelSize<",
  read$2: function(array, pixelSize) {
    ...
    return outBuffer.toString$0(outBuffer);
  },
  _readInt$1: function(bytes) {
    var result, i;
    if (typeof bytes !== "string" && (typeof bytes !== "object" || bytes === null || bytes.constructor !== Array && !bytes.$isJavaScriptIndexingBehavior()))
      return this._readInt$1$bailout(1, bytes);
    for (result = 0, i = 0; i < bytes.length; ++i)
      result += $.CONSTANT8.$shl($.$$and$n(bytes[i], 255), 8 * i);
    return result;
  },
  _readInt$1$bailout: function(state0, bytes) {
    var t1, result, i;
    for (t1 = $.getInterceptor$as(bytes), result = 0, i = 0; $.CONSTANT8.$lt(i, t1.get$length(bytes)); ++i)
      result += $.CONSTANT8.$shl($.$$and$n(t1.$index(bytes, i), 255), 8 * i);
    return result;
  },
  _readColor$1: function(b) {
    var red, green, blue;
    if (typeof b !== "string" && (typeof b !== "object" || b === null || b.constructor !== Array && !b.$isJavaScriptIndexingBehavior()))
      return this._readColor$1$bailout(1, b);
    if (2 >= b.length)
      throw $.ioore(2);
    red = this._toHex$1(b[2]);
    if (1 >= b.length)
      throw $.ioore(1);
    green = this._toHex$1(b[1]);
    if (0 >= b.length)
      throw $.ioore(0);
    blue = this._toHex$1(b[0]);
    return "#" + red + green + blue;
  },
  _readColor$1$bailout: function(state0, b) {
    var t1, red, green, blue;
    t1 = $.getInterceptor$as(b);
    red = this._toHex$1(t1.$index(b, 2));
    green = this._toHex$1(t1.$index(b, 1));
    blue = this._toHex$1(t1.$index(b, 0));
    return "#" + red + green + blue;
  },
  _toHex$1: function(val) {
    var result = $.toRadixString$1$n(val, 16);
...
$._TypedArrayFactoryProvider_createUint8Array_fromBuffer = function(buffer, byteOffset, $length) {
  if ($length == null)
...
$.Lists_getRange$bailout = function(state0, a, start, $length, accumulator) {
  ...
  if ($.CONSTANT10.$gt(end, t1.get$length(a)))
    throw $.$$throw($.RangeError$value(end));
  for (i = start; i < end; ++i)
...
$.UnsupportedImageFormatException$ = function() {
  return new $.UnsupportedImageFormatException();
};
...
$.CONSTANT1 = new $.EventStreamProvider("change");
$.CONSTANT2 = new $.EventStreamProvider("load");
...
(function() {
  ...
  $.dynamicSetMetadata([["Document", v3_Document], ["HTMLMediaElement", v0_MediaElement], ["SVGElement", v1_SvgElement], ["Element", v2_Element], ["Node", v4_Node], ["EventTarget", [v4_Node, "EventTarget|DOMWindow|FileReader"].join("|")], ["Uint8Array", "Uint8Array|Uint8ClampedArray"]]);
})();
...
//@ sourceMappingURL=image2css.dart.js.map
