...
$.draw = function() {
  var time = $.mul($.Date_Date$now().get$millisecondsSinceEpoch(), 0.002);
  var x = $.sin(time) * 96 + 128;
  var y = $.cos($.mul(time, 0.9)) * 96 + 128;
  var t1 = $.ctx;
  t1.set$fillStyle('rgb(245,245,245)');
  t1.fillRect$4(0, 0, 255, 255);
  t1 = $.ctx;
  t1.set$fillStyle('rgb(255,0,0)');
  t1.beginPath$0();
...
//@ sourceMappingURL=Balle.dart.js.map